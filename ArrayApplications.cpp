...
{
	ClearBackground( );
	// Draw line bottom left corner to the upper right corner
	glColor4f(1.0f, 0.0f, 0.0f, 1.0f);
	dae::DrawLine(Point2f{ 0.0f,0.0f }, Point2f{ g_WindowWidth, g_WindowHeight });

// line from the upper left corner to the botto; right corner
	glColor4f(1.0f, 1.0f, 0.0f, 1.0f);
	dae::DrawLine(Point2f{ 0.0f, g_WindowHeight }, Point2f{g_WindowWidth,0.0f});

	dae::DrawRect(Rectf{ 0.0f,0.0f,100.0f,100.0f });
